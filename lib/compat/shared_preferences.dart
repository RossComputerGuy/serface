...
class SharedPreferencesGokai extends SharedPreferencesStorePlatform {
  SharedPreferencesGokai({ required this.context });
  ...
  Future<File?> _getLocalDataFile() async {
    final dir = fs.directory(context.packageConfigDir);
    if (!(await dir.exists())) {
      await dir.create(recursive: true);
    }
    return dir.childFile('shared_preferences.json');
  }
